...
let UpdateRobotModule = proxyquire('../../robot/update-robot', {
...
describe('Update Robot', () => {
    ...
    it('should reject when the response utility handler says it should', (done) => {
        ...
        UpdateRobotModule.UpdateRobot.execute({
            ...
            expect(postSpy).toHaveBeenCalledWith({ url: 'https://api.fake.wink.com/robots/768', json: { name: "Data" }, headers: { Authorization: 'Bearer JUNKTOKEN' } }, jasmine.any(Function));
