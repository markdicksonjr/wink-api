...
let GetGroupsModule = proxyquire('../../user/get-groups', {
...
describe('Get Groups', () => {
    ...
    it('should reject when the response utility handler says it should', (done) => {
        ...
        GetGroupsModule.GetGroups.execute({
            ...
            expect(getSpy).toHaveBeenCalledWith({ url: 'https://api.fake.wink.com/users/me/groups', json: {}, headers: { Authorization: 'Bearer JUNKTOKEN' } }, jasmine.any(Function));
