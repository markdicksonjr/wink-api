...
let GetScenesModule = proxyquire('../../user/get-scenes', {
...
describe('Get Scenes', () => {
    ...
    it('should reject when the response utility handler says it should', (done) => {
        ...
        GetScenesModule.GetScenes.execute({
            ...
            expect(getSpy).toHaveBeenCalledWith({ url: 'https://api.fake.wink.com/users/me/scenes', json: {}, headers: { Authorization: 'Bearer JUNKTOKEN' } }, jasmine.any(Function));
