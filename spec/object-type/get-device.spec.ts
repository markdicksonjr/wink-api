...
let GetDeviceModule = proxyquire('../../object-type/get-device', {
...
describe('Get Device', () => {
    ...
    it('should reject when the response utility handler says it should', (done) => {
        ...
        GetDeviceModule.GetDevice.execute({
            ...
            expect(getSpy).toHaveBeenCalledWith({ url: 'https://api.fake.wink.com/locks/564', json: {}, headers: { Authorization: 'Bearer JUNKTOKEN' } }, jasmine.any(Function));
