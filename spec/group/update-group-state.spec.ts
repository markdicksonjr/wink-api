...
let UpdateGroupStateModule = proxyquire('../../group/update-group-state', {
...
describe('Update Group', () => {
    ...
    it('should reject when the response utility handler says it should', (done) => {
        ...
        UpdateGroupStateModule.UpdateGroupState.execute({
            ...
            expect(updateSpy).toHaveBeenCalledWith({ url: 'https://api.fake.wink.com/groups/3456789/activate', json: {desired_state: { position: 1 }}, headers: { Authorization: 'Bearer JUNKTOKEN' } }, jasmine.any(Function));
